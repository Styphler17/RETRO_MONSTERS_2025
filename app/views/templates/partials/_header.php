    ...
    <header
        ...
        <nav
            ...
            <div class="flex items-center">
                <a href="/RETRO_MONSTERS_2025/public/index.php">
                    <img
                        src="/RETRO_MONSTERS_2025/public/images/Logo_RetroMonsters.png"
                        alt="RetroMonsters Logo"
                        class="h-32 mr-3 absolute"
                        style="top: -28px" />
                </a>
                <a href="/RETRO_MONSTERS_2025/public/index.php" class="text-white font-bold text-xl hidden">RetroMonsters</a>
            </div>
            ...
            <div class="hidden md:flex items-center">
                <a
                    ...
                    href="/RETRO_MONSTERS_2025/public/index.php">Monstres</a>
                <a
